...
function blossom_fashion_admin_notice() {
    ...
    $dismissnonce   = wp_create_nonce( 'blossom-fashion-update-notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p class="dismiss-link"><strong><a href="?blossom-fashion-update-notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss','blossom-fashion' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function blossom_fashion_ignore_admin_notice() {
    ...
    if ( isset( $_GET['blossom-fashion-update-notice'] ) && $_GET['blossom-fashion-update-notice'] = '1' && wp_verify_nonce( $_GET['_wpnonce'], 'blossom-fashion-update-notice' )) {
