	...
	private function get_product_pages_data( $product_pages ) {
		...
		$pages = [
			'otter-page' => [
				...
				'plugin'  => $otter_plugin,
				'strings' => [
					'heading'      => __( 'Build innovative layouts with Otter Blocks and Gutenberg', 'riverbank' ),
					'text'         => __( 'Otter is a lightweight, dynamic collection of page building blocks and templates for the WordPress block editor.', 'riverbank' ),
					'buttons'      => [
						'install_otter_free' => __( "Install Otter - It's free!", 'riverbank' ),
						'install_now'        => __( 'Install Now', 'riverbank' ),
						'learn_more'         => __( 'Learn More', 'riverbank' ),
						'learn_more_link'    => tsdk_utmify( 'https://themeisle.com/plugins/otter-blocks/', 'otter-page', 'about-us' ),
					],
					'features'     => [
						'advancedTitle' => __( 'Advanced Features', 'riverbank' ),
						'advancedDesc'  => __( 'Add features such as Custom CSS, Animations & Visibility Conditions to all blocks.', 'riverbank' ),
						'fastTitle'     => __( 'Lightweight and Fast', 'riverbank' ),
						'fastDesc'      => __( 'Otter enhances WordPress site building experience without impacting site speed.', 'riverbank' ),
						'mobileTitle'   => __( 'Mobile-Friendly', 'riverbank' ),
						'mobileDesc'    => __( 'Each block can be tweaked to provide a consistent experience across all devices.', 'riverbank' ),
					],
					'details'      => [
						's1Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-builder.png',
						's1Title' => __( 'A Better Page Building Experience', 'riverbank' ),
						's1Text'  => __( 'Otter can be used to build everything from a personal blog to an e-commerce site without losing the personal touch. Otter’s ease of use transforms basic blocks into expressive layouts in seconds.', 'riverbank' ),
						's2Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-patterns.png',
						's2Title' => __( 'A New Collection of Patterns', 'riverbank' ),
						's2Text'  => __( 'A New Patterns Library, containing a range of different elements in a variety of styles to help you build great pages. All of your website’s most important areas are covered: headers, testimonials, pricing tables, sections and more.', 'riverbank' ),
						's3Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-library.png',
						's3Title' => __( 'Advanced Blocks', 'riverbank' ),
						's3Text'  => __( 'Enhance your website’s design with powerful blocks, like the Add to Cart, Business Hours, Review Comparison, and dozens of WooCommerce blocks.', 'riverbank' ),
					],
					'testimonials' => [
						'heading' => __( 'Trusted by more than 300K website owners', 'riverbank' ),
						'users'   => [
							[
	...
	private function get_other_products_data() {
		$products = [
			...
			'templates-patterns-collection'       => [
				...
				'description' => __( 'Design, save, and revisit your templates anytime with your personal vault on Templates Cloud.', 'riverbank' ),
			],
		];
